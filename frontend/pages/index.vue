<template>
  <div>
    ...
    <section class="hero container">
      ...
      <p class="hero__intro">{{ about?.intro ?? 'Self-taught senior developer and DevOps engineer. 15 years building on Drupal, PHP, Docker, and Linux. Currently at Eksponent. Also volunteering for South African History Online since 2018. Documentary photographer.' }}</p>
    </section>
